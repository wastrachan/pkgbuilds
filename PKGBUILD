...
license=('MIT')
depends=('git' 'gnupg')
_source_url="https://github.com/sobolevn/git-secret"
source=("LICENSE::${_source_url}/raw/v${pkgver}/LICENSE.md"
        "${pkgname}-${pkgver}.tar.gz::${_source_url}/archive/v${pkgver}.tar.gz")
